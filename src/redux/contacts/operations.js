  ...
  async (newContact, { rejectWithValue }) => {
    try {
      ...
      toast.promise(promise, {
        ...
        error: 'Could not add a new contact. Try again later',
      });
    ...
    async (contactId, { rejectWithValue }) => {
      try {
        ...
        toast.promise(promise, {
          ...
          error: 'Contact could not be deleted. Try again later',
        });
        const response = await promise;
        return response.data;
      } catch {
...
export { fetchContacts, addContact, editContact, deleteContact };